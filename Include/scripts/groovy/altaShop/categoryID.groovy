...
class categoryID {
	 ...
	 */
	// TC.categoryID.001
	// User want to see category by ID using valid HTTP Method request
	...
	def setValidURLY1() {
		println ("Visit https://alta-shop.herokuapp.com/api/categories/2")
		response = WS.sendRequest(findTestObject('Products Category/TC Get category by ID/categoryID.001'))
	}
	...
	// TC.categoryID.002
	// User want to see category by ID using invalid HTTP Method request
	@Given("User Set method to POST Y2")
	def setValidY2() {
	...
	def setValidURLY2() {
		println ("Visit https://alta-shop.herokuapp.com/api/categories/2")
		response = WS.sendRequest(findTestObject('Products Category/TC Get category by ID/categoryID.002'))
	}
