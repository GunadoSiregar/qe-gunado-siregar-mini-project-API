...
class allproducts {
	 ...
	 */
	// TC.allproducts.001
	// User want to see all product using valid HTTP Method request
	...
	def setValidURLU1() {
		...
		response = WS.sendRequest(findTestObject('Products/TC Get all products/products.001'))
	}
	...
	// TC.allproducts.002
	// User want to see all product using invalid HTTP Method request
	...
	def setValidURLU2() {
		println ("Visit https://alta-shop.herokuapp.com/api/products")
		response = WS.sendRequest(findTestObject('Products/TC Get all products/products.002'))
	}
